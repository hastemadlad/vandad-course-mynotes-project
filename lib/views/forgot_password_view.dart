...
import 'package:learningdart/utilities/dialog/password_reset_email_sent_dialog.dart';
...
class _ForgotPasswordViewState extends State<ForgotPasswordView> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      ...
      child: Scaffold(
        appBar: AppBar(title: Text("LOW MEMORY HAVER's VIEW")),
        body: Padding(
          padding: const EdgeInsets.all(16.0),
          child: Column(
            children: [
              const Text(
                'Enter the email you want to reset, entering other users email is punishable by death',
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Type your email baby girl',
                ),
              ),
              TextButton(
                onPressed: () {
